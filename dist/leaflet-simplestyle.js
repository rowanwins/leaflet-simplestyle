(function () {
    ...
    var sanitizerBundle = createCommonjsModule(function (module) {
    ...
    function collapse_dots(path) {
      ...
      for (var q; (q = p.replace(r, '$1')) != p; p = q) {}  return p;
    }
    ...
    var sanitizeCaja = function(_) {
        if (!_) return '';
        return sanitizerBundle(_, cleanUrl, cleanId);
    };
    ...
    function markerStyle (f, latlon, options) {
        return L.marker(latlon, {
            ...
            title: strip_tags(sanitizeCaja((f.properties && f.properties.title) || ''))
        });
    }
